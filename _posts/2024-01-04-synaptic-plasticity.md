...
_Anticipation_ is an intention to response to a kind of stimuli by a specific behavior. [^anticipation] To do so, anticipation modulates the network by facilitating the synapses along the neural pathway, if exists, from the stimuli to the behavior. In this way, it is ensured that, when stimulated, it is the neural pathway which mediates the behavior rather than any other that is activated. Importantly, **modulation of neural pathway is chemically mediated**. [^modulation]
