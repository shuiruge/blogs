...
For plasticity it is important. [^breath-example]  
  ...
  [^chemical-modulators]: There are two kinds of receptors on the membranes of synapses. One is ionotropic receptor, which _mediates_ behaviors by propagating electrical signals. The other is metabotropic receptor, which _modulates_ behaviors by modifying the strength of synapses. Metabotropic receptor, when activated, produces chemical modulators in the synapse to facilitate the release or/and the reception of neurotransmitters. These chemical modulators will persist for a while, from hundreds of milliseconds to minutes.

    For the types of receptor, see chapter 11 of _Principles of Neural Science_. And for the details of metabotropic receptors and how chemical modulators are produced, see chapters 13 and 14 of the same book.
