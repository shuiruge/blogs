...
[^problem]: As far as we can imply from the modular perspective, when we perceive what's being perceived, there must be a module that projects what's received back to the consciousness. The problem is whether or not there are multiple such modules. For example, whether or not, for each sense door, there's one such module that only for the awareness of this sense door. This is critical.
